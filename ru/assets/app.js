(() => {
  ...
  const I18N = {
    et: {
      ...
      progressOf: "/ 6",
      statusText: {
        ok: "🟢 Tugev riskiprofiil",
        mid: "🟡 Mõõdukas riskiprofiil",
        bad: "🔴 Nõrk riskiprofiil"
      },
      labels: {
        basis: "Nõude alus",
        breach: "Rikkumine",
      ...
      gradeWord: (v) => (v >= 2 ? (v === 3 ? "Tugev" : "Piisav") : (v === 1 ? "Nõrk" : "Kriitiline")),
      shortNotes: {
        basis: { 3:"Selgelt tuvastatav.", 2:"Tuvastatav, kuid mitte kirjalikult.", 1:"Sisu vajab täpsustamist.", 0:"Kohustus ei ole tuvastatav." },
        breach: { 3:"Selgelt tuvastatav.", 2:"Tõenäoline, kuid lünklik.", 1:"Vaidlustatav.", 0:"Ei ole kindel." },
        damage: { 3:"Arvutus kontrollitav.", 2:"Ligikaudne arvutus.", 1:"Ebamäärane.", 0:"Rahaliselt määramata." },
        evidence:{ 3:"Tõendibaas tugev.", 2:"Tõendeid on olemas.", 1:"Tõendeid on piiratud.", 0:"Tõendid puuduvad." },
        defenses:{ 3:"Vaidlusrisk madal.", 2:"Vaidlusrisk võimalik.", 1:"Vaidlusrisk suur.", 0:"Vastuväited väga tugevad." },
        limitation:{ 3:"Aegumisohtu ei tuvastatud.", 2:"Ebatõenäoline.", 1:"Võimalik.", 0:"Tõenäoline." }
      },
      phase2: {
        reasons: {
          limitation: {
            ...
            2:"Aegumisoht ei näi tõenäoline, kuid mõistlik on teha kontroll.",
            3:""
          },
          evidence: {
            ...
            2:"Tõendeid on olemas, kuid nende katvus vajab kriitilist ülevaatust.",
            3:""
          },
          basis: { 0:"Kohustuse olemasolu ei ole esialgse hinnangu alusel tuvastatav; nõude alus vajab ümber sõnastamist ja allikate kinnitamist.", 1:"Kohustuse sisu vajab olulist täpsustamist, et nõude alus oleks selge.", 2:"", 3:"" },
          breach:{ 0:"Rikkumise olemasolu või seos kohustusega ei ole piisavalt tuvastatav; vaja on selgemat rikkumise kirjeldust.", 1:"Rikkumise seos konkreetse kohustusega võib olla vaieldav ja vajab täpsustamist.", 2:"", 3:"" },
          damage:{ 0:"Nõude suurus ei ole rahaliselt määratletud ega põhjendatud; vaja on arvutuskäiku ja alusandmeid.", 1:"Nõude suurus vajab täiendavat põhjendust ja selgemat arvutuskäiku.", 2:"", 3:"" },
          defenses:{ 0:"Võimalikud vastuväited võivad oluliselt piirata nõude elujõulisust; vaja on koostada vastuväidete käsitlus.", 1:"Vaidlusrisk on arvestatav; mõistlik on kaardistada peamised vastuväited ja vastused neile.", 2:"", 3:"" },
          weakCount:"Mitme riskikoha koosesinemine suurendab ebakindlust; enne edasist sammu tasub nõrku komponente sihipäraselt parandada."
        },
        conditions: {
          limitation: "Aegumise küsimus vajab kontrolli.",
          evidence: "Tõendibaasi tuleb täiendada.",
          core: "Nõude tuuma komponent vajab täpsustamist (alus/rikkumine/kahju).",
          defenses0: "Vastuväidete käsitlus on vajalik."
        },
        action: {
          basisTitle: "Nõude alus",
          basis: [
    ...
    ru: {
      ...
      gradeWord: (v) => (v >= 2 ? (v === 3 ? "Сильный" : "Достаточный") : (v === 1 ? "Слабый" : "Критический")),
      shortNotes: {
        basis: { 3:"Основание чётко определимо.", 2:"Основание есть, но без письменного подтверждения.", 1:"Требуется уточнение содержания обязанности.", 0:"Основание не определяется." },
        breach: { 3:"Нарушение чётко установимо.", 2:"Вероятно, но подтверждено неполностью.", 1:"Спорно.", 0:"Неясно." },
        damage: { 3:"Расчёт проверяем.", 2:"Приблизимый расчёт.", 1:"Неопределённо.", 0:"В деньгах не определено." },
        evidence:{ 3:"Сильная доказательственная база.", 2:"Доказательства есть.", 1:"Доказательства ограниченные.", 0:"Доказательства отсутствуют." },
        defenses:{ 3:"Низкий риск спора.", 2:"Риск спора возможен.", 1:"Высокий риск спора.", 0:"Возражения могут быть очень сильными." },
        limitation:{ 3:"Риск давности не выявлен.", 2:"Маловероятно.", 1:"Возможно.", 0:"Вероятно." }
      },
      phase2: {
        reasons: {
          limitation: {
          ...
          basis: { 0:"Наличие обязанности по первичной оценке не определяется; основание требования требует переформулирования и подтверждения источников.", 1:"Содержание обязанности требует существенного уточнения, чтобы основание было ясным.", 2:"", 3:"" },
          breach:{ 0:"Наличие нарушения или его связь с обязанностью недостаточно определимы; требуется более чёткое описание нарушения.", 1:"Связь нарушения с конкретной обязанностью может быть спорной и требует уточнения.", 2:"", 3:"" },
          damage:{ 0:"Сумма требования не определена и не обоснована; нужен расчёт и исходные данные.", 1:"Сумма требования требует дополнительного обоснования и более ясного расчёта.", 2:"", 3:"" },
          defenses:{ 0:"Потенциальные возражения могут существенно снизить жизнеспособность требования; необходима проработка возражений.", 1:"Риск спора существенный; разумно определить ключевые возражения и ответы на них.", 2:"", 3:"" },
          weakCount:"Совокупность нескольких зон риска повышает неопределённость; перед следующим шагом целесообразно целенаправленно улучшить слабые компоненты."
        },
        conditions: {
  ...
  const lang = (document.documentElement.lang || "et").toLowerCase().startsWith("ru") ? "ru" : "et";
  const T = I18N[lang];
  ...
  function init() {
    ...
    steps.forEach(step => {
      ...
      // info toggles (supports span role=button)
  ...
  function applyUnlocks() {
    ...
    // done markers (optional, supports timeline)
    steps.forEach(s => {
  ...
  function decide(a) {
    ...
    if (overall === "ok") return "JAH"; // internal decision enum
  ...
  function pickReasons(a) {
    ...
    // Hide "2" reasons on strong decision (keep your original logic)
    if (decision === "JAH") {
      return reasons.filter(r => !String(r.text).includes("katvus") && !String(r.text).includes("покрытие")).slice(0,3);
    }
  ...
  function renderPhase2(a) {
    ...
    // action plan (collapsible sections)
